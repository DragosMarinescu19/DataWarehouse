...
insert into staging_customer(customer_id,customer_name,city,country) values(1006,'New_customer6','city6','country6');
update staging_customer set customer_name='New_customer17' where customer_id=1
